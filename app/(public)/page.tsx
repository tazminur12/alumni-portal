...
const alumniHighlights = [
  ...
  },
  {
    name: "Nasreen Begum",
    batch: "2008",
    role: "Doctor at Dhaka Medical",
    initials: "NB",
  },
  {
    name: "Kamal Hossain",
    batch: "2010",
    role: "Civil Engineer, PWD",
    initials: "KH",
  },
  {
    name: "Fatema Khatun",
    batch: "2012",
    role: "Teacher at AMHS",
    initials: "FK",
  },
];
...
const stats = [
  { label: "Total Alumni", value: "2,500+", icon: Users },
  { label: "Batches", value: "40+", icon: GraduationCap },
  { label: "Events Held", value: "120+", icon: Calendar },
];
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {alumniHighlights.map((alumni) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-muted">{alumni.role}</p>
              </div>
            ))}
          </div>
